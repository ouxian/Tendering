...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/provincial/header_winCom_Pie.css">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/provincial/gdpindex/gdp_winCom_Pie.js"></script>
...
<div class="container-content">
    ...
    <div class="right">
        ...
        <%--<div class="right-bottom" id = "graph2">--%>
