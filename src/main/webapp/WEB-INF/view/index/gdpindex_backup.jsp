...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/provincial/drawingCircle.js"></script>
    ...
    <div class="right">
        <div class="right-content">
            <select id="selectID" class="selectpicker" data-live-search="true" data-max-option="1" data-style="btn-info">
                <option value="1">不同年份项目采购总金额分布图</option>
                <option value="2">不同类型项目采购总金额分布图</option>
                <option value="3">同类型规划设计机构中标总金额分布图</option>
                <option value="4">同类型规划设计机构项目个数分布图</option>
                <option value="5">我院中标金额及项目数分布图</option>
                <option value="6">我院业务占有额度对比分布图</option>
            </select>
        </div>
